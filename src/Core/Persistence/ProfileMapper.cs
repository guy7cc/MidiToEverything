...
internal static class ProfileMapper
{
    ...
    private static AppSettings ToDomain(SettingsDto s) => new()
    {
        ...
        StartEmissionEnabled = s.StartEmissionEnabled,
        TrayNotifications = s.TrayNotifications,
        Theme = s.Theme,
        AccentColor = s.AccentColor,
        UiScale = s.UiScale,
        AutoDetectDevices = s.AutoDetectDevices,
        ObsHost = s.ObsHost,
        ObsPort = s.ObsPort,
    ...
    public static ConfigDto ToDto(AppConfig config) => new()
    {
        ...
        Settings = new SettingsDto
        {
            ...
            UpdateChannel = config.Settings.UpdateChannel,
            UpdateCheckHours = config.Settings.UpdateCheckHours,
            StartMinimized = config.Settings.StartMinimized,
            CloseToTray = config.Settings.CloseToTray,
            StartEmissionEnabled = config.Settings.StartEmissionEnabled,
            TrayNotifications = config.Settings.TrayNotifications,
            Theme = config.Settings.Theme,
            AccentColor = config.Settings.AccentColor,
            UiScale = config.Settings.UiScale,
            AutoDetectDevices = config.Settings.AutoDetectDevices,
