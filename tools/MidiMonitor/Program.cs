...
// Pump Win32 messages on this thread so DevicesWatcher receives WM_DEVICECHANGE
// (hot-plug). Ctrl+C posts WM_QUIT to break the pump.
var pumpThreadId = MessagePump.CurrentThreadId();
Console.CancelKeyPress += (_, e) =>
{
    e.Cancel = true;
    MessagePump.Quit(pumpThreadId);
};
MessagePump.Run();
